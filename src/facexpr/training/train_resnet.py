...
def main():
    parser = argparse.ArgumentParser(
        description="Train a facial-expression classifier with ResNet50 backbone"
    )
    parser.add_argument("--data-dir", type=str, required=True,
                        help="Path to data/downloaded_data containing train/val/test folders")                    
    parser.add_argument("--batch-size", type=int, default=32)
    parser.add_argument("--epochs", type=int, default=10)
    parser.add_argument("--lr", type=float, default=1e-3)
    parser.add_argument("--save-path", type=str, default="outputs/models/model.pth",
